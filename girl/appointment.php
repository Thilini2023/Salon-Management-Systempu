                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <p> Book your appointment to save salon blossom.</p>
                            <form method="post">
                                <div class="row">
                                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> No24/A, Blossom Salon & Spa, Colombo 07, Srilanka </li>
                                <li><i class="fa fa-phone"></i> +94 115 465 008</li>
                                <li><i class="fa fa-fax"></i> +94 775 679 349</li>
                                <li><i class="fa fa-envelope-o"></i> BlossomSalon@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                        <div class="footer-widget widget-newsletter">
                            ...
                            <p>Enter your email address to receive new information and other useful information right to your inbox.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>created by @2022 | blossom salon</p>
                            </div>
                        </div>
                    </div>
                </div>
